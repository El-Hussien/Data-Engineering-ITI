...
SELECT SUM(TotalDue) AS [Sum Total Due] FROM Sales.SalesOrderHeader WHERE OrderDate BETWEEN '7/1/2001' AND '7/31/2014' GROUP BY OrderDate 
...
SELECT rowguid, Name, SalesPersonID, Demographics INTO store_Archive1 FROM Sales.Store WHERE 1 = 2
